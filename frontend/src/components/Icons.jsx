...
export const CameraIcon = ({ size = 24, color = 'currentColor', fill = 'none' }) => (
...
export const PinIcon = ({ size = 18, color = 'currentColor', fill = 'none' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BellIcon = ({ size = 22, color = 'currentColor', fill = 'none' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const UserIcon = ({ size = 22, color = 'currentColor', fill = 'none' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const StreetlightIcon = ({ size = 18, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    {/* Streetlight pole and hanging lamp */}
    <path d="M7 22V5a3 3 0 0 1 6 0v2" />
    <path d="M11 7h4l1 3H10l1-3z" />
    <circle cx="13" cy="12" r="1.5" />
    <path d="M13 13.5v2m-3-2H8" opacity="0.4" />
  </svg>
);
...
export const PlusIcon = ({ size = 12, color = 'currentColor' }) => (
